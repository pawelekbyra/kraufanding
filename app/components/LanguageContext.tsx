...
export const translations = {
  ...
  en: {
    ...
    donationDescription: "Audience contributions help grow the project and support the creation of new content. As a thank you for your tip, you are invited to the Patron Zone.",
