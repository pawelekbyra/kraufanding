...
export const translations = {
  pl: {
    ...
    donationDescription: 'Wsparcie od widzów pomaga rozwijać serwis PawelPerfect.pl i tworzyć kolejne materiały. W podziękowaniu otrzymujesz dostęp do Strefy Fenkju.',
  ...
  en: {
    ...
    donationDescription: "Viewer support helps develop PawelPerfect.pl and create new content. As a thank-you, you receive access to the Thank You Zone.",
