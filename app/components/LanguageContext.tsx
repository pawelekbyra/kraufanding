...
export const translations = {
  pl: {
    ...
    donationDescription: 'Wpłaty od widzów pomogą szybko rozwnąć projekt i stworzyć kolejne materiały. W podziękowaniu za napiwek zapraszam do Strefy Patronów.',
  ...
  en: {
    ...
    donationDescription: "Viewer contributions will help rapidly grow the project and create new content. In appreciation for your tip, I invite you to the Patrons' Zone.",
