...
export const translations = {
  pl: {
    ...
    noMoneySub: 'Ja też nie, dlatego kombinuję. Ty też kombinuj: poleć stronę 5 znajomym i zdobądź w nagrodę dostęp do Strefy Patrona.',
    noMoneyHowTitle: 'O co w tym chodzi?',
    noMoneyHowText: 'Zasada jest prosta: Jeśli dzięki Twojemu poleceniu zarejestruje się u nas 5 nowych osób, system automatycznie przyzna Ci wejściówkę do Strefy Patrona.',
    ...
    noMoneyStep4: 'Ciesz się dostępem: Gdy piąta osoba potwierdzi swoje konto, Strefa Patrona odblokuje się dla Ciebie na stałe.',
  ...
  en: {
    ...
    noMoneySub: "Me neither, that's why I'm hustling. You hustle too: refer 5 friends and gain access to the Patron Zone as a reward.",
    noMoneyHowTitle: "What's this about?",
    noMoneyHowText: "The rule is simple: if 5 new people register through your referral, the system will automatically grant you access to the Patron Zone.",
    ...
    noMoneyStep4: 'Enjoy access: Once the fifth person confirms their account, the Patron Zone will unlock for you permanently.',
