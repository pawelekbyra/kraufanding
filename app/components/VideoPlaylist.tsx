              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-white border border-[#3b82f6]/30 rounded py-4 px-12 font-mono text-3xl font-black text-black text-center focus:ring-0 outline-none transition-all placeholder:opacity-20"
