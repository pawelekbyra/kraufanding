              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-[#BFDBFE] border border-[#1a1a1a] rounded-lg py-4 px-12 font-mono text-3xl font-black text-[#1e40af] text-center focus:ring-0 outline-none transition-all placeholder:opacity-20"
