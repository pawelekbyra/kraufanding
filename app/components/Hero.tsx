  ...
  return (
    <section className="bg-[#FDFBF7]">
      <div className="w-full">
        {/* FEATURED MEDIA */}
        <div className="relative aspect-video w-full rounded-2xl overflow-hidden shadow-sm border border-[#1a1a1a] mb-3 group bg-black">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-2">
            <div className="flex items-center gap-2 md:gap-3 min-w-0 w-full lg:w-auto">
               <Link
                 ...
                 className="w-10 h-10 rounded-full bg-[#FFFBEB] border border-[#1a1a1a] overflow-hidden shrink-0 hover:opacity-80 transition-opacity"
               >
                  <img
            ...
            <div className="flex items-center gap-2 w-full lg:w-auto">
               <div className="flex items-center bg-[#FFFBEB] rounded-full h-9 flex-[3] lg:flex-none overflow-hidden border border-[#1a1a1a]">
                  <button
                    onClick={handleLike}
                    disabled={isPending}
                    className={cn(
                        "flex items-center justify-center gap-2 pl-4 pr-3 h-full flex-1 hover:bg-[#FEF08A] transition-colors border-r border-[#1a1a1a] relative",
                  ...
                  <button
                    ...
                    disabled={isPending}
                    className={cn(
                        "flex items-center justify-center px-4 h-full flex-none hover:bg-[#FEF08A] transition-colors",
               ...
               <button
                 onClick={handleShare}
                 className="flex items-center justify-center gap-2 px-3 h-9 bg-[#FFFBEB] hover:bg-[#FEF08A] rounded-full transition-colors flex-[2] lg:flex-none border border-[#1a1a1a]"
               >
                  <Share2 size={16} />
                  <span className="text-[13px] font-semibold">{t.share}</span>
               </button>
               <button className="w-9 h-9 flex items-center justify-center bg-[#FFFBEB] hover:bg-[#FEF08A] rounded-full transition-colors shrink-0 border border-[#1a1a1a]">
        ...
        {/* DESCRIPTION BOX */}
        <div className="mt-3 bg-[#FFFBEB] rounded-2xl p-4 hover:bg-[#FEF08A] transition-colors cursor-pointer border border-[#1a1a1a]" onClick={() => setIsExpanded(!isExpanded)}>
