  ...
  return (
    <section className="bg-[#FDFBF7] pt-12 pb-8">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        {/* HEADER */}
        <div className="mb-10">
          <h1 className="text-4xl sm:text-6xl font-black uppercase tracking-tighter text-[#1a1a1a] mb-4">
            {campaign.title}
          </h1>
        ...
        {/* FEATURED IMAGE */}
        <div className="relative aspect-[21/9] w-full rounded-3xl overflow-hidden shadow-2xl border border-[#1a1a1a]/5 mb-12 group">
          <img
