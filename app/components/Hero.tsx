        ...
        <div className="space-y-3 pb-1 lg:px-2">
          ...
          <div className={cn("flex flex-col justify-between gap-2 lg:flex-row lg:items-center", styles.metaRow)}>
            ...
            <div className={cn("flex w-full flex-wrap items-center gap-2 lg:w-auto lg:flex-nowrap", styles.actionRail)}>
               <div className={cn("relative flex h-[36px] shrink-0 items-center rounded-[12px] bg-[var(--chan-blue)]", styles.actionCluster)}>
                  <button
                    onClick={handleLike}
                    disabled={isPending}
                    className={cn(
                        ...
                        styles.actionButton,
                        interactionState.isLiked ? "text-white" : "text-white/70",
                        isPending && "opacity-50"
                    )}
                    title="Lubię to"
                    aria-label="Lubię to"
                  >
                     <ThumbsUp className="h-4 w-4 shrink-0" strokeWidth={1.8} color={interactionState.isLiked ? "#fff" : "rgba(255,255,255,0.7)"} fill={interactionState.isLiked ? "#fff" : "none"} />
                  ...
                  <button
                    ...
                    className={cn(
                        ...
                        styles.actionButton,
                        interactionState.isDisliked ? "text-white" : "text-white/70",
                        isPending && "opacity-50"
                    )}
                    title="Nie lubię"
                    aria-label="Nie lubię"
                  >
                     <ThumbsDown className="h-4 w-4 shrink-0" strokeWidth={1.8} color={interactionState.isDisliked ? "#fff" : "rgba(255,255,255,0.7)"} fill={interactionState.isDisliked ? "#fff" : "none"} />
                  </button>
               </div>
               <ShareButton
               ...
               <button
                 ...
                 className={cn(
                   "relative flex h-9 flex-1 items-center justify-center gap-1.5 rounded-[12px] bg-[var(--chan-blue)] px-3 font-sans text-sm font-bold text-white transition-[transform,background-color,box-shadow] duration-160 hover:-translate-y-px active:scale-95 lg:flex-none",
