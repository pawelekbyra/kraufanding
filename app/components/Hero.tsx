  ...
  return (
    <section className="bg-[#FDFBF7]">
      <div className="w-full">
        ...
        <div className="space-y-3 pt-3">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-2">
            ...
            <div className="flex items-center gap-2 w-full lg:w-auto">
               <div className="flex items-center bg-[#FEF9C3] rounded-full h-9 flex-[3] lg:flex-none overflow-hidden border border-[#1a1a1a]">
                  <button
                    onClick={handleLike}
                    disabled={isPending}
                    className={cn(
               ...
               <button
                 onClick={handleShare}
                 className="flex items-center justify-center gap-2 px-3 h-9 bg-[#FEF9C3] hover:bg-[#FEF08A] rounded-full transition-colors flex-[2] lg:flex-none border border-[#1a1a1a]"
               >
                  <Share2 size={16} />
                  <span className="text-[13px] font-semibold">{t.share}</span>
               </button>
               <button className="w-9 h-9 flex items-center justify-center bg-[#FEF9C3] hover:bg-[#FEF08A] rounded-full transition-colors shrink-0 border border-[#1a1a1a]">
        ...
        {/* DESCRIPTION BOX */}
        <div className="mt-3 bg-[#FFFBEB] rounded-2xl p-4 hover:bg-[#FEF9C3] transition-colors cursor-pointer border border-[#1a1a1a]" onClick={() => setIsExpanded(!isExpanded)}>
